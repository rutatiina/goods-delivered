...
namespace Rutatiina\GoodsDelivered\Traits;
...
trait Validate
{
    ...
    private function validate()
    {
        ...
        $this->settings = GoodsDeliveredSetting::with(['financial_account_to_debit', 'financial_account_to_credit'])->first();
        ...
        $last_txn = GoodsDelivered::latest()->first();
