...
class GoodsDeliveredValidateService
{
    ...
    public static function run($requestInstance)
    {
        ...
        $data['app'] = 'web';
        $data['document_name'] = (empty($requestInstance->document_name)) ? $settings->document_name : $requestInstance->document_name;
        ...
        $data['contact_id'] = (empty($requestInstance->contact_id)) ? 0 : $requestInstance->contact_id;
