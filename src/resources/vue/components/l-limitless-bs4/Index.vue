        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">Delivery Notes</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Delivery Notes</span>
                    </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            let recordsPerPage = Math.floor((window.innerHeight - 230 - 80) /45)
            this.tableData.recordsPerPage = recordsPerPage
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/goods-delivered/'+txn.id })
            }
        },
        ready:function(){},
