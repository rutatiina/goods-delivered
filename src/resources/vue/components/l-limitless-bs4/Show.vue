        ...
        <div class="page-header page-header-light d-print-none">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-files-empty2 mr-2"></i> <span class="font-weight-semibold">Delivery Note</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Delivery Note</span>
                    </div>
                ...
                <div class="header-elements">
                    <div class="breadcrumb justify-content-center">
                        <router-link to="/goods-delivered/create"
                    ...
                    <div class="card-header header-elements-inline d-print-none text-danger">
                        ...
                        <div class="header-elements">
                            <button type="button"
                                    ...
                                    @click="txnApprove('/goods-delivered/'+txnData.id+'/approve')"><i class="icon-printer mr-2"></i> Click here to Approve</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card max-width-960 m-auto rg-print-border-0" v-if="!this.$root.loadingTxn">
                    ...
                    <div class="card-header bg-transparent header-elements-inline d-print-none">
                        ...
                        <div class="header-elements">
                            ...
                            <router-link :to="'/goods-delivered/'+$route.params.id+'/edit'"
                                         class="btn btn-light btn-sm">
                                <i class="icon-pencil mr-2"></i>
                                Edit
                            </router-link>

                            <router-link :to="'/goods-delivered/'+$route.params.id+'/copy'"
...
<script>
    ...
    export default {
        name: 'AccountingSalesCreditNotesShow',
        //components: {},
        data() {
            return {}
        },
