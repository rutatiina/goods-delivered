...
use Rutatiina\GoodsDelivered\Traits\TxnItemsJournalLedgers as TxnTraitsTxnItemsJournalLedgers;
...
class Store
{
    ...
    public function run()
    {
        ...
        try
        {
            ...
            {
                unset($item['taxes']);
                $item['goods_delivered_id'] = $this->txn['id'];
            ...
            {
                $ledger['goods_delivered_id'] = $this->txn['id'];
